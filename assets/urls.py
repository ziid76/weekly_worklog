...
urlpatterns = [
    ...
    path('systems/bulk-update/', views.SystemBulkUpdateView.as_view(), name='system_bulk_update'),
    path('systems/export/', views.SystemExportView.as_view(), name='system_export'),
    ...
    path('systems/<int:pk>/attachments/<int:attachment_id>/delete/', views.SystemAttachmentDeleteView.as_view(), name='system_attachment_delete'),
    path('inspections/dashboard/', views.RegularInspectionDashboardView.as_view(), name='inspection_dashboard'),
    ...
    path('contracts/<int:pk>/search-systems/', views.ContractSystemSearchView.as_view(), name='contract_search_systems'),
    path('contracts/<int:pk>/add-system/', views.AddContractSystemView.as_view(), name='contract_add_system'),
    path('contracts/<int:pk>/remove-system/', views.RemoveContractSystemView.as_view(), name='contract_remove_system'),
    ...
    path('topology/', views.AssetTopologyView.as_view(), name='topology'),
]
