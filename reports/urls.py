...
urlpatterns = [
    ...
    path('weekly/<int:report_id>/review/<int:user_id>/', views.get_ai_review_content, name='get_ai_review_content'),
    ...
    path('analysis/performance/', views.team_performance_list, name='team_performance_list'),
    path('analysis/performance/<int:pk>/', views.team_performance_detail, name='team_performance_detail'),
]
